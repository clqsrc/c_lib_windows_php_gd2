...
//clq 这个好象是说用到了 mmx 命令,而 vc6 是没有的,感觉这个文件的函数不提供也可以的
// #ifdef _MSC_VER
...
//clq vc6 不支持//static inline int _color_blend (const int dst, const int src)
static int _color_blend (const int dst, const int src)
{
...
//clq test//据说inline 是C99才有的关键字，C89没有，有部分编译器不支持
#define inline
